		...
		<main class="main-content card glass-card">
			...
			<section id="ch-intro" bind:this={chapterEls['ch-intro']}>
				{#if lang === 'es'}
					...
					<p class="intro-paragraph">Durante las últimas dos décadas, la respuesta predeterminada a "¿cómo hacemos la educación más atractiva?" ha sido engañosamente simple: agregar puntos, insignias y tablas de clasificación. Pon una barra de progreso en una tarea de lectura, otorga una estrella por completar un cuestionario y deja que la tabla de clasificación haga el resto. Este enfoque — comúnmente llamado gamificación PBL (Puntos, Insignias, Leaderboards) — se ha extendido por aulas, plataformas de capacitación corporativa y sistemas de gestión de aprendizaje con una velocidad notable.</p>
			...
			<section id="ch-systemic" bind:this={chapterEls['ch-systemic']}>
				...
				<ol>
					...
					<li><strong>Definición del Esquema de Juego.</strong> Diferentes géneros de juego tienen diferentes patrones estructurales. Un curso diseñado como un juego de aventura (narrativa en desarrollo, exploración, acertijos) tendrá una arquitectura diferente a uno diseñado como un simulador económico (gestión de recursos, optimización, curvas de crecimiento). BEM pide al diseñador que considere qué esquema de género se adapta mejor al contenido y las habilidades que se enseñan, en lugar de recurrir a un sistema genérico de puntos e insignias.</li>
				...
				<p>El enfoque sistémico es también lo que distingue a BEM del enfoque típico de caja de herramientas. Cuando un diseñador tiene una caja de herramientas (puntos, insignias, tablas de clasificación, misiones), la tentación es agregar elementos oportunistamente: "agreguemos una insignia para esto, una tabla de clasificación para aquello." El resultado es un mosaico de características que pueden o no funcionar juntas. El proceso de diseño de BEM fuerza la coherencia al comenzar con el objetivo de aprendizaje y construir hacia afuera, asegurando que cada elemento sirva a un propósito conectado con la meta central.</p>
			...
			<section id="ch-goals" bind:this={chapterEls['ch-goals']}>
				...
				<p>Por eso BEM insiste en un replanteamiento crucial: lo que el campo típicamente llama "recompensas" son simplemente metas diferidas. Una insignia no es una recompensa por completar una tarea; es una meta que el estudiante estaba persiguiendo y que ahora ha alcanzado. Un certificado no es un premio; es un estado meta hacia el cual el estudiante se orientaba. Al replantear las recompensas como metas, BEM desplaza la atención del diseñador de "¿qué les doy cuando terminan?" a "¿qué estado deberían querer alcanzar?" Si una insignia es una meta, entonces la pregunta no es si la insignia funciona, sino cómo está diseñada como meta y qué efectos produce. Hay insignias buenas y nocivas, y todo depende de su diseño.</p>
			...
			<section id="ch-elaborate" bind:this={chapterEls['ch-elaborate']}>
				...
				<p>La retroalimentación no es una señal monolítica. Un mismo fragmento de información puede entregarse de maneras que either empoderan al aprendiz para autocorregirse o crean dependencia de una explicación externa. BEM se basa en la investigación sobre retroalimentación instruccional para distinguir entre dos tipos fundamentales de retroalimentación, cada uno con efectos distintos sobre la carga cognitiva y los resultados de aprendizaje.</p>
			...
			<section id="ch-building" bind:this={chapterEls['ch-building']}>
				...
				<p>¡Pero cuidado! ¡No trates la retroalimentación como un premio! Esta es la razón por la que los PBL (Puntos, insignias y tablas de clasificación) son un concepto vinculado con las malas prácticas de gamificación. ¡Pero los puntos, las insignias y las tablas de clasificación son solo canales de retroalimentación! No son buenos ni malos por sí mismos, sino que dependen de las mecánicas detrás de ellos. Si tratas una insignia o un punto como una recompensa, estás perdiendo su valor de retroalimentación. Los PBL no tienen la culpa, sino sus diseñadores.</p>
				{:else}
			...
			<section id="ch-points" bind:this={chapterEls['ch-points']}>
				...
				<p>A lo largo de este artículo, hemos tratado los puntos, las insignias y las tablas de clasificación con escepticismo. Pero también hemos insistido en que no son inherentemente malos — son herramientas, y su valor depende completamente de las mecánicas que hay detrás de ellos. Este capítulo examina los puntos específicamente: qué son, qué pueden hacer y cómo diseñarlos para que sirvan al aprendizaje en lugar de socavarlo. Ah, sí, y por qué las insignias son solo otra forma de puntos.</p>
				...
				<p>¿Qué son los puntos? No son solo un número: son el uso combinado de un número, un nombre y, a veces, un icono. Piensa en una moneda de oro... ahora piensa en cien monedas de oro. Son icónicos, tienen un nombre y una cantidad. Cuando dices puntos de destreza, el nombre y el icono, si lo hay, sirven como ancla de significado para el número, lo que les da sentido. Y tener 3 insignias de excelencia es exactamente eso, ¡un tipo de punto! Las insignias son realmente solo una submecánica de los puntos que pone énfasis en el emblema.</p>
				...
				<h3>Puntos vs. Puntuaciones: Dos Funciones Diferentes</h3>
				<p>BEM traza una distinción clara entre <strong>puntos</strong> y <strong>puntuaciones</strong>, una distinción que la mayoría de los sistemas de gamificación eliminan:</p>
				<ul>
					<li><strong>Puntos</strong> tienen un rol transaccional. Se gastan, intercambian o usan para desbloquear contenido. Los puntos son la moneda del sistema — controlan el flujo y permiten decisiones. Como se consumen, crean elecciones significativas: "¿Gasto mis Puntos de Análisis para desbloquear el módulo avanzado, o los guardo para la rama de especialización?"</li>
					<li><strong>Puntuaciones</strong> tienen un rol informativo. Miden rendimiento, estado o progreso, pero no activan mecánicas directamente. Una puntuación de velocidad, una calificación de calidad, un porcentaje de finalización — estos le dicen al estudiante dónde está sin forzar una decisión. Las puntuaciones son el tablero; los puntos son el motor.</li>
				</ul>
				<p>Esta es una distinción de cómo se denominan a menudo en el diseño de juegos, y nos ayudará a categorizar mejor la gama más amplia de tipos de puntos.</p>
				<h3>Puntos como Mecánicas de Incentivos</h3>
				<p>Los puntos, las puntuaciones y las insignias no son números aislados. Están gobernados por <strong>algoritmos y reglas</strong> — las mecánicas que determinan cómo se ganan, pierden, calculan y muestran. Estas mecánicas no son neutrales. Llevan una filosofía. Moldean el comportamiento de maneras que el diseñador puede no anticipar, y pueden apoyar o socavar los objetivos motivacionales del sistema.</p>
				...
				<p>El mismo principio se aplica a las <strong>tablas de clasificación</strong>. Una tabla de clasificación sin filtrar ordenada por rendimiento total es una de las mecánicas más destructivas en educación. Les dice a los estudiantes con peor rendimiento exactamente lo lejos que están, sin un camino a seguir. Les dice a los estudiantes con mejor rendimiento que pueden relajarse. Crea una jerarquía fija y pública que desalienta el esfuerzo de quienes más lo necesitan e infla la complacencia en quienes menos lo necesitan.</p>
				<p>La postura de BEM sobre las tablas de clasificación es restrictiva: <strong>no las uses a menos que puedas implementar un emparejamiento adecuado, ligas y competición por niveles</strong>. Una tabla de clasificación que enfrenta a un novato contra un experto no es una competición — es una humillación pública. Una tabla de clasificación que agrupa a los estudiantes por nivel de habilidad, rota regularmente y se reinicia periódicamente puede crear competición amistosa. Pero la mayoría de los educadores carecen de las habilidades de diseño para implementar estas mecánicas avanzadas, y una tabla de clasificación mal diseñada hace más daño que bien.</p>
				<p>Si se usan tablas de clasificación, nunca deben vincularse directamente a la habilidad o el rendimiento. Pueden vincularse a indicadores lúdicos — solución más creativa, mayor mejora, revisiones entre pares más útiles — que creen competición amistosa sin castigar a los de bajo rendimiento. En el momento en que una tabla de clasificación se convierte en un ranking de quién es "mejor" en la materia, se ha convertido en una herramienta de intimidación, no de motivación.</p>
			...
			{#if lang === 'es'}
			<!-- CHAPTER 18: Conclusión -->
			<section id="ch-conclusion" bind:this={chapterEls['ch-conclusion']}>
				<h2>18. Conclusión: BEM como Infraestructura Pedagógica</h2>
