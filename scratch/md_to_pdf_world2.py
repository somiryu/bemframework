"""
Converts docs/world2_design.md to a styled PDF via markdown → HTML → PDF (WeasyPrint).
Section 7 (Logros, Medallas y Recompensas) is excluded.
"""
...
MD_PATH  = "docs/world2_design.md"
OUT_PATH = "static/learn_resources/resources/world2/diseno_mundo2_detras_de_camaras.pdf"
...
<head>
<meta charset="utf-8">
<title>Diseño del Mundo 2 — Detrás de Cámaras</title>
</head>
<body>
  <div class="cover">
    <div class="cover-header">ORGANIZACIÓN MUNDIAL DE LA INNOVACIÓN EDUCATIVA (OMIE)</div>
    <h1 class="cover-title">Diseño del Mundo 2</h1>
...
@page {
  ...
  @top-center {
    content: "OMIE · Mundo 2: El Modelo GFR y la Teoría de la Autodeterminación";
