"""
Converts docs/world1_design.md to a styled PDF via markdown → HTML → PDF (WeasyPrint).
...
MD_PATH  = "docs/world1_design.md"
OUT_PATH = "static/learn_resources/resources/world1/diseno_mundo1_detras_de_camaras.pdf"
...
<head>
<meta charset="utf-8">
<title>Diseño del Mundo 1 — Detrás de Cámaras</title>
</head>
<body>
  <div class="cover">
    <div class="cover-header">ORGANIZACIÓN MUNDIAL DE LA INNOVACIÓN EDUCATIVA (OMIE)</div>
    <h1 class="cover-title">Diseño del Mundo 1</h1>
...
@page {
  ...
  @top-center {
    content: "OMIE · Mundo 1: Iniciación en la OMIE y los 7 Drivers BEM";
